...
const About: React.FC<props> = (props) => {
  return (
    <div
      id="about"
      className={`${props.reached && "reached"} gradient-bg section relative z-50 grid h-[100vh] w-full pt-0 sm:mb-5 sm:mt-[0px] sm:border-t-[1px] sm:border-primary md:mb-[0px] md:border-t-0`}
    >
